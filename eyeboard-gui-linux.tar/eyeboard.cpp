...
/*When the eyes are moved to the left, the arrow moves down
When the eyes are moved to the right, the user chooses the letter
inside the box (Simulate events with the left and right arrow keys)*/
...
system("gedit record.txt"); //Opens file of the recorded text ( GNOME )
     return 0;
}
